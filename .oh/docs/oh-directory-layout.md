...
| `tasks/` | dir | Spec task workdirs — ephemeral build scratch (`<slug>/prd.md`, `prd.json`, `prompt.md`, `progress.txt`). | `.oh/scripts/spec-build.sh`, the `cleanup-tasks` cron, and `/spec`. |
