...
| [RSI survey mapping](rfc-rsi-survey-mapping.md) | Draft | #525 companion mapping the recursive-self-improvement survey ([arXiv 2607.07663](https://arxiv.org/html/2607.07663v1)) onto this repository: the taxonomy placement, the verification-hierarchy rung assignment for the harness's own signals, five findings the repo already evidences, and two proposed roadmap children. Decision artifact — no runtime change. |
