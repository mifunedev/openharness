...
- `.oh/evals/capability/repo-orientation/tasks.json` defines the held-out workload mix, including no-orientation sessions that still pay startup cost.
