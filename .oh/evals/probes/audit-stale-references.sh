...
set +e
hits=$(git grep -n -E "$pat" -- ':!CHANGELOG.md' ':!docs/rfcs/preserved-changelog-rationale.md' ':!.oh/evals/RESULTS.md' ':!.oh/evals/datasets/**' ':!.oh/tasks/archive/**')
rc=$?; set -e
...
for path in AGENTS.md docs/README.md docs/artifact-contract-schema.md crons/heartbeat.md .github/workflows/ci-harness.yml .oh/evals/capability/tasks/CB-001-ship-harness-change.md .oh/skills/benchmark/SKILL.md .oh/skills/spec/references/retro.md; do
