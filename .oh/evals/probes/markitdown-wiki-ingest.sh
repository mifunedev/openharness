...
need_literal "conversion failure does not execute cleanup" 'cleanup_document_attempt'
need_regex "quality-review failure cleanup absent" 'failed quality check must run `cleanup_document_attempt`'
