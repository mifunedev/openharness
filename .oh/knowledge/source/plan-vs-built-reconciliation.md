...
- `.oh/skills/spec/references/execute.md:446` — step 7 writes `evidence.md`; `:520` gates the undraft on it.
...
Knowledge Impact gate immediately before `evidence.md` (`execute.md:493`): the
