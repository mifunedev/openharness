...
- Extend existing `.oh/skills/wiki/corpus/` into a codebase knowledge graph v0.
...
- Treat CodeGraph as live source-code navigation infrastructure, not as durable project memory and not as a replacement for `.oh/skills/wiki/corpus/`/Lat.md-style knowledge.
