...
**`.oh/skills` symlink (automatic):**
The cherry-pick of an upstream commit editing `.claude/skills/<x>/SKILL.md`
applies the patch THROUGH the `.claude/skills → .oh/skills` symlink
and stages the real `.oh/skills/<x>/SKILL.md`. No manual retarget is
...
Origin divergences preserved: Denver TZ, client-slack-pi, .oh/skills symlink"
```
