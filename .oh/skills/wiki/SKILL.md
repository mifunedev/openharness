...
- **Corpus root**: entity pages at `.oh/skills/wiki/corpus/<slug>.md`; immutable
  snapshots at `.oh/skills/wiki/corpus/raw/<yyyy-mm-dd>-<slug>.md`. Create
  `.oh/skills/wiki/corpus/raw/` before any write — it is gitignored and may be
  absent on a fresh clone.
- **Gitignore-by-default**: `.oh/skills/wiki/corpus/*` is gitignored; the operator
...
- **Canonical schema**: frontmatter fields, body layout, slug derivation, the
  ...
  strategy all live in `.oh/skills/wiki/references/schema.md`. The reference docs
