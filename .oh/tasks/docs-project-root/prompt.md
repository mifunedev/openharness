...
# First Mate session — docs-project-root

You are the **First Mate** running one long-lived session that implements the
`docs-project-root` task end to end. Unlike a ralph loop — 50 fresh processes, one story
each — you hold the **whole task graph** in a single session and walk it
story by story.

- Task folder: `.oh/tasks/docs-project-root/` (`prd.md`, `prd.json`, `prompt.md`, `progress.txt`)
- Branch: `task/857-docs-project-root` — never push to `development` or `main`
- Issue: #857

## 1. Load the task graph

Read `.oh/tasks/docs-project-root/prd.md` for intent and the `## Codebase Patterns`
...
1. `STATUS: COMPLETE` as a **whole line** in `.oh/tasks/docs-project-root/progress.txt`.
...
`.oh/tasks/docs-project-root/evidence.md` per
...
- PRD: `.oh/tasks/docs-project-root/prd.md`
- Structured stories: `.oh/tasks/docs-project-root/prd.json`
- Progress + terminal marker: `.oh/tasks/docs-project-root/progress.txt`
- Branch: `task/857-docs-project-root`
- Issue: #857
