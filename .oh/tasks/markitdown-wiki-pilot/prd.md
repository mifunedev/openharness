...
- [ ] The orchestrator force-adds only the reviewed curated entry before regenerating `.oh/skills/wiki/corpus/README.md`; raw artifacts remain ignored. Pass `bash .oh/evals/probes/wiki-readme-index.sh`.
