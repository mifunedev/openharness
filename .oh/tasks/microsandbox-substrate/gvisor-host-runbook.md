...
This runbook records the state that the P0 spike left on the WSL2 host. The runbook
gives the operator three procedures: verify, exercise, and revert.
...
The spike measured 1.15x on `real` and 2.05x on `user`. Report both numbers. A
