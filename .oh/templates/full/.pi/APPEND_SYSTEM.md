...
You are running inside a project workspace. Check `AGENTS.md` and `CLAUDE.md` if present. They define the project's identity, terminology, operating principles, and local boundaries. Treat task-specific procedures as on-demand context rather than root instructions.
