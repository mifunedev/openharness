...
| `feat/` `bug/` `task/` `audit/` `skill/` | `git worktree` checkouts of in-flight harness branches, named after the branch prefix in `.oh/skills/git/SKILL.md`. |
...
mirrors the branch prefix from `.oh/skills/git/SKILL.md`. The dated
