...
| `/autopilot` | Self-improvement loop — select harness-infra item, scaffold + execute via /ship-spec + /delegate, finalize ready-for-review PR (cap 6 PRs/day, no auto-merge) |
