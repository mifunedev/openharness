...
| `/render-html` | Render an artifact as a bespoke, self-contained HTML file under `.oh/logs/<date>/<slug>.html` for one-shot human review (audit synthesis, council output, lint matrix, weekly digest) |
