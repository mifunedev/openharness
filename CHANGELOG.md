...
### Changed
- Restructure root agent guidance with risk-first sections, explicit failure modes, and complete skill routing ([#854](https://github.com/mifunedev/openharness/issues/854)).
