...
> **Archived.** This post reflects the v0 multi-agent framing. v1 OpenHarness is single-project: one repo, one sandbox, one default agent (Claude Code); multi-agent setups live in harness packs like [`@ryaneggz/mifune`](https://github.com/ryaneggz/mifune). Kept for history.
