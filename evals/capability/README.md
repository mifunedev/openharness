# evals/capability/ — Capability benchmark (the progress ceiling)
...
The capability benchmark and the probe suite (`evals/probes/*.sh`, see
...
| | Probe suite (`evals/probes/`) — the **floor** | Capability benchmark (`evals/capability/`) — the **ceiling** |
|---|---|---|
