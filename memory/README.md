...
| Item | Purpose |
|------|---------|
| `MEMORY.md` | Append-only lessons learned across sessions. See `.mifune/skills/retro/references/memory-protocol.md`. |
...
See `.mifune/skills/retro/references/memory-protocol.md` for the full protocol governing when to add lessons to `MEMORY.md`, how to structure them, and append-only discipline.
